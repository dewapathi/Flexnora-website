        ...
        <Reveal className="relative mx-auto max-w-[720px]">
          ...
          <div className="flex flex-wrap justify-center gap-3.5">
            <MagneticCTA
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#25d366] px-[42px] py-[18px] text-[1.05rem] font-semibold text-white shadow-[0_12px_30px_rgba(37,211,102,0.25)] transition-all hover:-translate-y-0.5 hover:bg-[#1fb855] hover:shadow-[0_16px_40px_rgba(37,211,102,0.4)] hover:scale-[1.08]"
            >
            ...
            <MagneticCTA
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-indigo to-cyan px-[42px] py-[18px] text-[1.05rem] font-semibold text-white shadow-[0_0_30px_rgba(29,78,216,0.3)] transition-all hover:-translate-y-0.5 hover:shadow-[0_0_50px_rgba(29,78,216,0.5)] hover:scale-[1.08] dark:shadow-[0_0_30px_rgba(99,102,241,0.3)] dark:hover:shadow-[0_0_50px_rgba(99,102,241,0.5)]"
            >
              <CalendarCheck className="h-5 w-5" /> Book Free Consultation
            </MagneticCTA>
            <MagneticCTA
              href="tel:+94779400291"
              className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface-2 px-[42px] py-[18px] text-[1.05rem] font-semibold text-text backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:bg-surface-3 hover:scale-[1.08]"
            >
