...
export const industries: Industry[] = [
  ...
  },
  {
    ...
    status: 'live',
    tagline: 'A full property management platform — reservations, rooms, guest profiles, housekeeping, and an AI concierge.',
    features: ['Executive dashboard', 'Reservations & room grid', 'Guest profiles & loyalty', 'Drag-and-drop housekeeping', 'AI concierge', 'Staff mobile app'],
    stack: ['Next.js', 'React Query', 'Recharts', 'Zustand'],
  },
  {
    slug: 'ecommerce',
